...
export const VaccinationSchedulesIndex: React.FC = () => {
  ...
  if (loading) {
    return <div className="text-center py-8">Loading vaccination schedules...</div>;
  }
  ...
  return (
    <div className="vaccination-schedules-index">
      ...
      {schedules.length === 0 ? (
        <p className="text-gray-600">No vaccination schedules found.</p>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {schedules.map((schedule) => (
            ...
            >
              ...
              <div className="mb-2">
                <span className="font-medium text-gray-700">Vaccine ID:</span> {schedule.vaccine_id}
              </div>
              <div className="mb-2">
