...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference("Check.count") do
      post checks_url, params: { check: { check_type: @check.check_type, frequency_id: @check.frequency_id } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { check_type: @check.check_type, frequency_id: @check.frequency_id } }
