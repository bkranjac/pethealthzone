...
export const ChecksSchedulesIndex: React.FC = () => {
  ...
  if (loading) {
    return <div className="text-center p-4">Loading checks schedules...</div>;
  }
  ...
  return (
    <div className="checks-schedules-index max-w-7xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800">Health Check Schedules</h1>
        <Link
      ...
      {schedules.length === 0 ? (
        <div className="text-center p-12 bg-gray-50 rounded-lg">
          <p className="text-gray-500 text-lg">No checks schedules found. Add your first schedule to get started!</p>
        </div>
      ) : (
