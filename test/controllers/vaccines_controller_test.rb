...
class VaccinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccine" do
    assert_difference("Vaccine.count") do
      post vaccines_url, params: { vaccine: { frequency_id: @vaccine.frequency_id, mandatory: @vaccine.mandatory, name: @vaccine.name } }
    end
  ...
  test "should update vaccine" do
    patch vaccine_url(@vaccine), params: { vaccine: { frequency_id: @vaccine.frequency_id, mandatory: @vaccine.mandatory, name: @vaccine.name } }
