...
export const MedicationSchedulesIndex: React.FC = () => {
  ...
  if (loading) {
    return <div className="text-center p-4">Loading medication schedules...</div>;
  }
  ...
  return (
    <div className="medication-schedules-index max-w-7xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800">Medication Schedules</h1>
        <Link
      ...
      {schedules.length === 0 ? (
        <div className="text-center p-12 bg-gray-50 rounded-lg">
          <p className="text-gray-500 text-lg">No medication schedules found. Add your first schedule to get started!</p>
        </div>
      ) : (
                ...
                <div className="mb-4 flex-grow">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">
                      ...
                      <span className="text-gray-600">{schedule.medication_id}</span>
                    </p>
                    <p className="text-sm">
