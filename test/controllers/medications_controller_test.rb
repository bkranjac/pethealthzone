...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference("Medication.count") do
      post medications_url, params: { medication: { amount: @medication.amount, expiration_date: @medication.expiration_date, name: @medication.name, purpose: @medication.purpose } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { amount: @medication.amount, expiration_date: @medication.expiration_date, name: @medication.name, purpose: @medication.purpose } }
